...
class BoardVotingScreen extends StatefulWidget {
  const BoardVotingScreen({super.key});

  @override
  State<BoardVotingScreen> createState() => _BoardVotingScreenState();
}

class _BoardVotingScreenState extends State<BoardVotingScreen> {
  @override
